...
public class ChercheurGuildeMutuelle {
    public static final String MESSAGE_AIDE_ID_GUILDE = "Pour récupérer l'ID d'une guilde il suffit de faire un clic droit sur l'onglet du channel en question et cliquer sur \"Copier l'ID\"";
