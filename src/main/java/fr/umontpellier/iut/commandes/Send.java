...
public interface Send extends Commande {
    ...
    default void sendErrorMessage(String message, TextChannel textChannel) {
    ...
    default void execute(Message messageRecue) {
        ...
        } catch (NeedInformationUserException e) {
            messageRecue.getChannel().sendMessage(e.getMessage()).queue();
        }
    }

    void execute(String textChannel, String message, User user) throws NeedInformationUserException;
}
