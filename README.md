...
<img src="./ressources/cape.gif" alt="Harry potter met la cape d'invisibilité" width="300"/>
...
Bien sûr avant d'envoyer la commande assurez-vous que le serveur sur le quelle vous voulez envoyez le message anonyme soit en commun avec le bot, [(s'il ne l'est pas, invitez le en cliquant ici)](https://discord.com/oauth2/authorize?client_id=766973211559854091&scope=bot&permissions=0).
